      ...
      <Container>
        ...
        <div>
          <div className="px-4 sm:px-0">
            <h3 className="text-base text-xl font-semibold leading-7">
              Your Information
            </h3>
            <br />
            <p className="mt-1 max-w-xl font-semibold text-lg leading-2">
              {username}님의 정보입니다.
            </p>
          </div>
          <div className="flex -space-x-1 overflow-hidden m-auto w-100 py-6">
            <img
              className="inline-block h-20 w-20 rounded-full m-auto ring-2 ring-white"
              src={profile_image}
            />
          </div>
          <div className="m-auto mt-6 border-t border-gray-100">
            <dl className="divide-y divide-gray-100">
              <div className="px-4 py-6 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
                <dt className="text-xl font-semibold font-medium leading-6">
                  Name
                </dt>
              ...
              <br />
              <br />
              <p className="mt-3 max-w-xl font-semibold text-xl leading-6">
                생성한 설문조사
              </p>
