...
const KakaoCallback = () =>{
    ...
    useEffect(()=>{
        ...
        axios.post(`https://kauth.kakao.com/oauth/token?grant_type=${grant_type}&client_id=${client_id}&redirect_uri=http://localhost:3000/oauth&code=${code}`,
        {
            header:{
                "Content-type":
