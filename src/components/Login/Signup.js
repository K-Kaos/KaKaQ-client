                ...
                <div class="p-20 px-10 space-y-4 md:space-y-6 sm:p-8" style={{ alignItems: "center" }}>
                    <div class="w-auto md:w-auto isolate px-36 py-2 sm:py-32 lg:px-8">
                        ...
                        <div class="grid grid-cols-1 gap-x-8 gap-y-6 sm:grid-cols-2">
                            ...
                            <div class="sm:col-span-2" style={{ alignItems: "center" }}>
                                <label for="company" class="block text-sm font-semibold leading-6 text-gray-900">이메일</label>
                                <div class="mt-2.5">
                                    <input type="text"
                                        id="email"
                                        name="email"
                            ...
                            <div class="sm:col-span-2">
                                <label for="company" class="block text-sm font-semibold leading-6 text-gray-900">비밀번호</label>
                                <div class="mt-2.5">
                                    <input type="password"
                                        id="password"
                                        name="password"
                            ...
                            <div class="sm:col-span-2">
                                <label for="email" class="block text-sm font-semibold leading-6 text-gray-900">비밀번호 확인</label>
                                <div class="mt-2.5">
                                    <input type="password"
                                        id="confirmPassword"
