            ...
            <div className="w-auto md:w-auto isolate px-36 py-2 sm:py-32 lg:px-8">
              <div className="mx-auto max-w-2xl text-center">
                ...
                <p className="mt-2 text-lg leading-8 text-gray-600">
                  KaKaQ에 가입하여 여러 편리한 설문조사 기능을 이용해보세요.
                </p>
              </div>
              <br />
              <div className="grid grid-cols-1 gap-x-8 gap-y-6 sm:grid-cols-2">
                <div className="sm:col-span-2">
                  <div className="flex flex-col sm:flex-row items-center">
                    <label
                      for="username"
                      className="block text-sm font-semibold leading-6 text-gray-900 sm:w-1/4 mb-2 sm:mb-0 sm:mr-4 sm:text-right"
                    >
                      사용자 이름
                    </label>
                ...
                <div className="sm:col-span-2">
                  <div className="flex flex-col sm:flex-row items-center">
                    <label
                      for="email"
                      class="block text-sm font-semibold leading-6 text-gray-900 sm:w-1/4 mb-2 sm:mb-0 sm:mr-4 sm:text-right"
                    >
                      비밀번호 확인
                    </label>
                    <div className="flex-1">
