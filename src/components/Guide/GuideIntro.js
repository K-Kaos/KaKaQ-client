      ...
      <div class="py-24 sm:py-32">
        <div class="mx-auto max-w-7xl px-6 lg:px-8">
          <div class="mx-auto max-w-2xl lg:mx-0">
            <h2 class="text-3xl font-semibold leading-7">KaKaQ가 처음이신가요?</h2>
            <p class="mt-6 text-base font-bold tracking-tight text-gray-700 sm:text-base">아래 가이드를 따라 진행해보세요.  <br /></p>
          </div>
          <div class="mx-auto mt-10 grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 border-t border-gray-200 pt-10 sm:mt-16 sm:pt-16 lg:mx-0 lg:max-w-none lg:grid-cols-4">
            <article class="flex max-w-xl flex-col items-center justify-between">
              <div class="flex items-center ">
                <img src={makesurvey} alt="" class="h-40 w-40 rounded-xl bg-gray-50" />
              </div>
              <div class="group relative ">
                ...
                <p class="mt-3 line-clamp-4 text-sm leading-6 text-gray-600">설문조사 직접 생성 / 챗봇을 이용한 설문조사를 이용하여 생성합니다.</p>
              </div>
            </article>
            <article class="flex max-w-xl flex-col items-center justify-between">
              <div class="flex items-center ">
                <img src={share} alt="" class="h-40 w-40 rounded-xl bg-gray-50" />
              </div>
              <div class="group relative">
                ...
                <p class="mt-3 line-clamp-3 text-sm leading-6 text-gray-600">생성한 설문조사를 친구 / 동료들과 링크로 공유하세요.</p>
              </div>
            </article>
            <article class="flex max-w-xl flex-col items-center justify-between">
              <div class="flex items-center ">
              ...
              <div class="group relative">
                ...
                <p class="mt-3 line-clamp-3 text-sm leading-6 text-gray-600">자신이 위치한 지역을 대상으로 하는 설문조사에 참여하세요. </p>
              </div>
            </article>
            <article class="flex max-w-xl flex-col items-center justify-between">
              <div class="flex items-center ">
                <img src={result} alt="" class="h-40 w-40 rounded-xl bg-gray-50" />
              </div>
              <div class="group relative">
                <h3 class="mt-6 text-lg font-semibold leading-6 text-gray-900 group-hover:text-gray-600">
                  <span class="absolute inset-0"></span>
                ...
                <p class="mt-3 line-clamp-3 text-sm leading-6 text-gray-600">자신이 참가한, 생성한 설문조사의 결과를 확인하세요. </p>
              </div>
            </article>
          </div>
        </div>
      ...
      <div class="py-24 sm:py-32">
        <div class="mx-auto max-w-7xl px-6 lg:px-8">
          <div class="mx-auto max-w-2xl lg:text-center">
            <p class="text-base font-semibold leading-7 text-indigo-600">챗봇 기반 설문 제작 웹서비스</p>
            <h2 class="mt-2 font-bold tracking-tight text-gray-900 sm:text-4xl">설문 제작자와 응답자 모두 <br />
              쉽고’, ‘편하고’, ‘재미있게’ 사용</h2>
