      ...
      <div class="py-24 sm:py-32">
        <div class="mx-auto max-w-7xl px-6 lg:px-8">
          <div class="mx-auto max-w-2xl lg:mx-0">
            <h2 class="text-3xl font-semibold leading-7 text-indigo-600">KaKaQ가 처음이신가요?</h2>
            <p class="mt-6 text-base font-bold tracking-tight text-gray-900 sm:text-base">아래 가이드를 따라 진행해보세요.  <br /></p>
          </div>
