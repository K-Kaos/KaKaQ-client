...
function NavBar(props) {
  ...
  function NavButton({ to, text }) {
    return (
      <Link
        to={to}
        className="text-black text-2xl px-4 py-2 items-center bg-white-50 border border-gray-300 rounded-lg hover:bg-gray-100 font-medium p-2"
    ...
    <nav class="bg-transparent dark:bg-gray-900">
      <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4 container-fluid">
        ...
        <div class="justify-between ml-4 mr-4 items-center bg-transparent hidden w-full md:block md:w-auto" id="navbar-dropdown">
          <ul class="mr-6 bg-transparent flex flex-col text-2xl font-medium p-4 md:p-0 mt-4 rounded-lg bg-gray-50 md:flex-row md:space-x-8 md:mt-0 md:border-0 md:bg-transparent dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
            <li>
            ...
            <li>
              ...
              <div id="dropdownNavbar" class="hidden">
                <ul class="text-xl absolute py-2 text-sm text-gray-700 dark:text-gray-400 position:absolute" aria-labelledby="dropdownLargeButton">
                  <li>
            ...
            {isLogin ?
              <li>
                <button onClick={handleLogout} className="text-black text-2xl px-4 py-2 items-center bg-white-50 border border-gray-300 rounded-lg hover:bg-gray-100 font-medium p-2">Logout</button>
              </li>
              :
              <>
                <li>
